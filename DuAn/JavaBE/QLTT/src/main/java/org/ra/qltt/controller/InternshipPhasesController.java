...
public class InternshipPhasesController {
    ...
    public ResponseEntity<?> getIP(){
        ...
        return ResponseEntity.ok(ResponseWrapper.success(internshipPhaseResponseDTOList,"success.resource.all" , HttpStatus.OK.value()));
    }
    ...
    public ResponseEntity<?> getIPById(@PathVariable Long id){
        ...
        return ResponseEntity.ok(ResponseWrapper.success(internshipPhaseResponseDTO,"success.resource.find" , HttpStatus.OK.value()));
    }
    ...
    public ResponseEntity<?> createIP(@Valid @RequestBody InternshipPhaseRequestDTO internshipPhaseRequestDTO){
        ...
        return ResponseEntity.ok(ResponseWrapper.success(internshipPhaseResponseDTO,"success.resource.create",HttpStatus.CREATED.value()));
    }
    ...
    public ResponseEntity<?> updateIP(@Valid @RequestBody InternshipPhaseRequestDTO internshipPhaseRequestDTO , @PathVariable Long id){
        ...
        return ResponseEntity.ok(ResponseWrapper.success(internshipPhaseResponseDTO, "success.resource.update", HttpStatus.OK.value()));
    }
