...
public class EvaluationCriteriaController {
    ...
    public ResponseEntity<?> getEC(){
        ...
        return ResponseEntity.ok(ResponseWrapper.success(evaluationCriterionResponseDTO,"success.resource.all" , HttpStatus.OK.value()));
    }
    ...
    public ResponseEntity<?> getECById(@PathVariable Long id){
        ...
        return ResponseEntity.ok(ResponseWrapper.success(evaluationCriterionResponseDTO,"success.resource.find" , HttpStatus.OK.value()));
    }
    ...
    public ResponseEntity<?> createEC(@Valid @RequestBody EvaluationCriterionRequestDTO evaluationCriterionRequestDTO){
        ...
        return ResponseEntity.ok(ResponseWrapper.success(evaluationCriterionResponseDTO,"success.resource.create",HttpStatus.CREATED.value()));
    }
    ...
    public ResponseEntity<?> updateEC(@Valid @RequestBody EvaluationCriterionRequestDTO evaluationCriterionRequestDTO , @PathVariable Long id){
        ...
        return ResponseEntity.ok(ResponseWrapper.success(evaluationCriterionResponseDTO,"success.resource.update",HttpStatus.OK.value()));
    }
